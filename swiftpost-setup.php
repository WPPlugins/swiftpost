...
function swiftpost_database_install() {
	...
	$found_tables = $wpdb->get_col("SHOW TABLES LIKE '{$wpdb->prefix}swiftpost%';");
		...
		dbDelta("CREATE TABLE IF NOT EXISTS {$wpdb->prefix}swiftpost_nativepost (
				  ...
				  status varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'live',
				  run int(11) NOT NULL DEFAULT '1',
				  impressions int(11) NOT NULL DEFAULT '0',
				  order_id int(15) NOT NULL DEFAULT '0',
				  lineitem_id int(15) NOT NULL DEFAULT '0',
				  slotid varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
				  startdate date NOT NULL DEFAULT '0000-00-00',
				  starttime varchar(12) NOT NULL DEFAULT '12:00am',
				  enddate date NOT NULL DEFAULT '0000-00-00',
				  endtime varchar(12) NOT NULL DEFAULT '11:45pm',
				  fc varchar(6) COLLATE utf8mb4_unicode_ci NOT NULL,
				  fc_impressions varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL,
				  fc_howmany varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL,
				  fc_type varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
				  fc_lifetime varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
				  gd varchar(6) COLLATE utf8mb4_unicode_ci NOT NULL,
				  geo text COLLATE utf8mb4_unicode_ci NOT NULL,
				  post_status varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'off',
		...
		dbDelta("CREATE TABLE IF NOT EXISTS {$wpdb->prefix}swiftpost_abtest (
				  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
				  name varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'A/B Test',
				  hypothesis text,
				  ...
				  enddate date NOT NULL DEFAULT '0000-00-00',
				  endtime varchar(12) NOT NULL DEFAULT '11:45pm',
				  status varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'running',
				  created datetime NOT NULL,
				  timestamp timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
				  PRIMARY KEY  (id),
				  KEY startdate (startdate),
